...
def c_furniture(c):
    ...
    lr.shifted(c, guitar, 1, -52)
    # a slumped beanbag in the corner
    BB, BB_DK, BB_LT = hexc('7a2e28'), hexc('551f1b'), hexc('94403a')
    c.shadow(292, 112, 16, 2, 110)
    c.ellipse(292, 104, 15, 9, hexc('2a1210'))
    c.ellipse(292, 104, 14, 8, BB)
